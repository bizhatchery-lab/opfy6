        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-6">
          ...
          <div>
            <Link to="/" className="mb-4 hover:opacity-80 transition-opacity inline-block">
              <div className="flex items-center justify-center gap-2 px-2 py-1 h-auto" style={{ backgroundColor: 'rgba(55, 65, 81, 0.5)', borderRadius: '10px' }}>
                <img src="https://cdn.builder.io/api/v1/image/assets%2F33c55feb7bb542699c50b2b385d21d9f%2Ffb6fb834270f414b9c5cd5f21643fcc1" alt="OperateForYou" className="h-8 w-auto object-contain brightness-0 invert flex-shrink-0" />
                <img src="https://cdn.builder.io/api/v1/image/assets%2F33c55feb7bb542699c50b2b385d21d9f%2F11b71ac627234a73ab8fdf09d5c02add" alt="OperateForYou" className="h-6 w-auto object-contain brightness-0 invert flex-shrink-0" />
              </div>
            </Link>
