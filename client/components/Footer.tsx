        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-6">
          ...
          <div>
            <Link to="/" className="mb-4 hover:opacity-80 transition-opacity inline-block">
              <div className="flex items-center gap-1 px-2 py-1" style={{ backgroundColor: 'rgba(55, 65, 81, 0.5)', borderRadius: '10px', width: '146px', height: '48px', transform: 'translateX(5px)' }}>
