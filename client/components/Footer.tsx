        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-6">
          ...
          <div>
            <Link to="/" className="flex items-center gap-1 mb-4 hover:opacity-80 transition-opacity">
              ...
              <img src="https://cdn.builder.io/api/v1/image/assets%2F33c55feb7bb542699c50b2b385d21d9f%2F11b71ac627234a73ab8fdf09d5c02add" alt="OperateForYou" className="h-28 w-auto object-contain brightness-0 invert translate-y-1" style={{ transform: 'translateX(-5px) translateY(1px)' }} />
            </Link>
